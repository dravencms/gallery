...
class AclOperationFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        $operations = [
            'gallery' => [
                'edit' => 'Umožnuje editaci gallery',
                'delete' => 'Umožnuje smazání gallery'
            ]
        ];
    ...
    {
        return ['Dravencms\Model\Gallery\Fixtures\AclResourceFixtures', 'Dravencms\Model\User\Fixtures\GroupFixtures'];
    }
}